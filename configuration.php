...
class JConfig {
	...
	public $sitename = 'user\'s Site!';				// Name of Joomla site
	...
	public $password = '3b8013f07a';						// DB password
	public $db = 'bitnami_joomla';							// DB database name
	public $dbprefix = 'jos_';					// Do not change unless you need to!

	/* Server Settings */
	public $secret = 'a208b127e02e64e85a6cb2ee03aa35f0'; 		// Change this to something more secure
	public $gzip = '0';
	...
	public $ftp_pass = '6zv59DnwW2FZmWA8vNQO0hbanJlwovy92uedR7RdkTqPMyyArs';
