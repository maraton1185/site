...
<form action="<?php echo JRoute::_('index.php?option=com_ebook&view=order&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-horizontal">
