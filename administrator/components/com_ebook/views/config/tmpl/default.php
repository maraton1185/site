...
<form action="<?php echo JRoute::_('index.php?option=com_ebook'); ?>" method="post" name="adminForm" id="message-form" class="form-validate form-horizontal">
	<fieldset>
		<div>
			<div class="modal-header">
				<h3><?php echo JText::_('COM_EBOOK_MY_SETTINGS');?></h3>
			</div>
