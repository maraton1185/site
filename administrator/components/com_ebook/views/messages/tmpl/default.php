...
<form action="<?php echo JRoute::_('index.php?option=com_ebook&view=messages'); ?>" method="post" name="adminForm" id="adminForm">
			...
			<table class="table table-striped">
				<thead>
					<tr>
						...
						<th class="title">
							<?php echo JHtml::_('grid.sort', 'COM_EBOOK_HEADING_SUBJECT', 'a.subject', $listDirn, $listOrder); ?>
						</th>
						<th width="5%">
							<?php echo JHtml::_('grid.sort', 'COM_EBOOK_HEADING_READ', 'a.state', $listDirn, $listOrder); ?>
						</th>
						<th width="15%">
							<?php echo JHtml::_('grid.sort', 'COM_EBOOK_HEADING_FROM', 'a.user_id_from', $listDirn, $listOrder); ?>
						</th>
				...
				<?php foreach ($this->items as $i => $item) :
					$canChange = $user->authorise('core.edit.state', 'com_ebook');
					?>
					<tr class="row<?php echo $i % 2; ?>">
						...
						<td>
							<a href="<?php echo JRoute::_('index.php?option=com_ebook&view=message&message_id='.(int) $item->message_id); ?>">
								<?php echo $this->escape($item->subject); ?></a>
						</td>
						<td class="center">
							<?php echo JHtml::_('ebooks.state', $item->state, $i, $canChange); ?>
						</td>
						<td>
