 ...
 * @since       1.6
 */
class EbookControllerMessage extends JControllerForm
{
	/**
	...
	public function reply()
	{
		...
		{
			$this->setRedirect('index.php?option=com_ebook&view=message&layout=edit&reply_id=' . $replyId);
		}
		else
		{
			$this->setMessage(JText::_('COM_EBOOK_INVALID_REPLY_ID'));
			$this->setRedirect('index.php?option=com_ebook&view=messages');
		}
	}
}
