 ...
 * @since       1.6
 */
class EbookModelConfig extends JModelForm
{
	/**
	...
	protected function populateState()
	{
		...
		// Load the parameters.
		$params	= JComponentHelper::getParams('com_ebook');
	...
	public function &getItem()
	{
		...
		$this->preprocessData('com_ebook.config', $item);
	...
	{
		// Get the form.
		$form = $this->loadForm('com_ebook.config', 'config', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form))
		{
			return false;
		}
	...
	public function save($data)
	{
		...
		{
			$this->setError('COM_EBOOK_ERR_INVALID_USER');
			return false;
		}
	}
}
