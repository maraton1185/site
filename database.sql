...
--
-- Table structure for table `jos_ebook_serials`
--

DROP TABLE IF EXISTS `jos_ebook_serials`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `jos_ebook_serials` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `jos_ebook_serials`
--

LOCK TABLES `jos_ebook_serials` WRITE;
/*!40000 ALTER TABLE `jos_ebook_serials` DISABLE KEYS */;
/*!40000 ALTER TABLE `jos_ebook_serials` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-09-14 11:18:50
